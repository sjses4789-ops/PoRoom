          ...
          <table className="w-full min-w-[320px] text-left text-sm">
            <thead>
              <tr className="text-xs text-neutral-400">
                ...
                <th className="py-2 text-right font-medium">승</th>
                <th className="py-2 text-right font-medium">패</th>
                <th className="py-2 text-right font-medium">무</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => {
